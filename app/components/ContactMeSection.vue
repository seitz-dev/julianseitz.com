<template>
  <div
    id="contact"
    class="min-h-fit flex flex-col select-none gap-12 items-center justify-between"
  >
    ...
    <NuxtImg loading="lazy" alt="Discord Avatar" class="hover hover:scale-110! drop-shadow-lg" width="512" height="512" src="/av.webp" />
